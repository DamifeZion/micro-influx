...
export const CreateCampaignForm: React.FC<TCreateCampaignFormProp> = ({
   closeModal,
}) => {
   ...
   return (
      <React.Fragment>
         {!isDesktop && (
            <Button
               onClick={() => navigate(-1)}
               className="py-6 px-0 flex items-center gap-2 text-primary bg-transparent border-none shadow-none hover:bg-transparent"
            >
         ...
         <Form {...form}>
            <form
               ...
               className="[&_input]:border-2 [&_input]:bg-transparent [&_input]:border-muted-foreground/30 [&_textarea]:border-2 [&_textarea]:border-muted-foreground/30 [&_label]:text-primary [&_textarea]:bg-transparent"
            >
               <div className="space-y-2 lg:px-6">
                        ...
                        <FormItem>
                           ...
                           <FormControl>
                              ...
                              >
                                 <SelectTrigger
                                    className={cn(
                                       "h-12 border-2 border-muted-foreground/30 py-2",
                                       {
                  ...
                  <FormField
                     ...
                     render={({ field }) => (
                        <FormItem>
                           <FormLabel>Select Preferred Channels</FormLabel>
                              ...
                              <div className="flex items-center gap-2 flex-wrap">
                                 {CAMPAIGN_CHANNELS.map((item, index) => (
                                    <Label
                                       ...
                                       htmlFor={item}
                                       className={cn(
                                          "size-fit p-2 cursor-pointer bg-transparent border-2 border-muted-foreground/30 rounded-sm !text-muted-foreground/30 hover:text-muted-foreground/30",
                                          {
